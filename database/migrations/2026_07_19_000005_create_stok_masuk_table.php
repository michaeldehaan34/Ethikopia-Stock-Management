...
return new class extends Migration
{
     ...
     * Kolom ini menjadi kolom VARCHAR(12) di tabel stok_masuk & update_stok
     * agar data lama tetap kompatibel (nama kolom = kode bahan).
     */
    ...
    {
        // Tabel transaksi Stok Masuk. Nama tabel dipertahankan dari Flask.
        // Setiap bahan master memiliki 1 kolom VARCHAR(12).
