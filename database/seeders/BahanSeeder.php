...
{
    /**
     * Master data bahan (mirrors MASTER_DATA di Flask modules/master_bahan.py).
     * Tuple: [kode, nama, kategori, kelompok, satuan].
     * `urutan` = indeks 0-based di array ini (sesuai Flask _ORDER).
     */
    private const MASTER_DATA = [
        ...
        ['sauce_caramel', 'Caramel', 'Bahan Baku Bar', 'Sauce & Concentrate', 'liter'],
        ...
        ['gula_sachet', 'Gula', 'Bahan Baku Bar', 'Sweetener', 'sachet'],
    ...
    {
        // Idempoten: jangan ubah data lama, hanya seed bila kosong.
        if (Bahan::count() > 0) {
            return;
        }
