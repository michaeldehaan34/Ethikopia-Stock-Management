...
@section('title', ($title ?? 'Edit Stok Masuk') . ' - Ethikopia Stock Management')
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('manager.stok-masuk.update', $id) }}" id="stokMasukForm" autocomplete="off">
                        @csrf
                        <div class="row mb-4">
