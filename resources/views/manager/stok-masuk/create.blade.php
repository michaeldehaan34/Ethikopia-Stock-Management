        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-2">
                    <h2 class="mb-0">
                        <i class="bi bi-plus-lg me-2"></i>{{ $title ?? 'Tambah Stok Masuk' }}
                    </h2>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('manager.stok-masuk.store') }}" id="stokMasukForm" autocomplete="off">
                        @csrf
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('barista') is-invalid @enderror" id="barista" name="barista"
                                    value="{{ old('barista', ($default_data['barista'] ?? ($barista_name ?? ''))) }}" required>
