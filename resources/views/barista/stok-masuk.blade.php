    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h2 class="mb-0"><i class="bi bi-box-arrow-in-down me-2"></i>Stok Masuk</h2>
                    <p class="text-muted mb-0">Catat stok masuk bahan baku</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Form Stok Masuk</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('barista.stok-masuk.store') }}" id="stokMasukForm" autocomplete="off">
                        @csrf
                        <div class="row mb-4">
                                                                ...
                                                                <div class="barang-grid">
                                                                    @foreach ($grp['items'] as $item)
                                                                        <div class="barang-card input-with-unit">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-sm item-input" id="{{ $item['kode'] }}" name="{{ $item['kode'] }}" value="{{ old($item['kode'], '') }}" inputmode="decimal" placeholder="0">
